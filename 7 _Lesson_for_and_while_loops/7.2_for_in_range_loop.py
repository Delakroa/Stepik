...
# 1, 2, 3, 4  (будьте внимательны, правая граница не включительно). Если нам нужны числа от 1 до 5 включительно,
...
# генерации чисел.
#
# Например, вызов функции range(1, 10, 2) создаст последовательность чисел 1, 3, 5, 7, 9, а вызов
# функции range(5, 30, 5)
