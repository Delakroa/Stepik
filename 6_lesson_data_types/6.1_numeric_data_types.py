...
num_min = min(a, b, c, d, f)
print(f"Наименьшее число = {num_min}")

num_max = max(a, b, c, d, f)
...
result_average = (x + y + z) - number_min - number_max
if (number_max - number_min) == result_average:
...
# Даны пять чисел a1, a2, a3, a4, a5. Напишите программу, которая вычисляет сумму их модулей |a1| + |a2| + |a3| + |a4|
# + |a5|".
...
a4 = float(input())
a5 = float(input())
print(number_sum = abs(a1) + abs(a2) + abs(a3) + abs(a4) + abs(a5))
